print("it's time for game, so let's get this over with!!" "\U0001F601")
print("Instruction")
print("--------------------")
...
while True:
    ...
    if User_action == computer_action:
        ...
        if computer_action == "S":
            ...
            print("Paper covers Rock, You lose." "\U0001F602")    
            
    elif User_action =="P":
        if computer_action == "R":
            print("Paper covers Rock, You win!" "\U0001F601")
            break
        else:
        ...
        if computer_action == "P":
            print("Scissors cuts Paper, You win!" "\U0001F601")
            break
        else:
